...
- a decreasing bounded below sequence has a limit.
- an increasing bounded above sequence has a limit.
- $\{1,0,1,0,1,0,\ldots\}$ does not have a limit.
- $\left\{\frac{1}{1},\frac{1}{2},\frac{1}{3},\ldots\right\}$ has a limit.
